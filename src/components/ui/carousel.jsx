...
const Slide = ({ slide, index, current, handleSlideClick }) => {
  ...
  const { src, button, title, demoClick } = slide;

  return (
    <div className="perspective-[1200px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col items-center justify-center relative text-center text-white opacity-100 transition-all duration-300 ease-in-out w-[90vmin] h-[70vmin] mx-[4vmin] z-10 mobile-carousel-section"
        ...
        >
          ...
          <div className="flex justify-center">
            <button
              onClick={() =>
                demoClick
                  ? window.open(demoClick, "_blank", "noopener,noreferrer")
                  : null
              }
              className={
                button
...
const CarouselControl = ({ type, title, handleClick }) => {
  return (
    ...
    >
      ...
      <img src={upRightArrow} alt="upright-arrow" />
    </button>
  );
};
